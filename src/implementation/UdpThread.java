...
public class UdpThread implements Runnable {
    ...
    public void run() {
        try {
            ...
            res = (udpPacket.operation < 10) ? new DatagramPacket(outgoing, outgoing.length, InetAddress.getByName(""), udpPacket.fePort) : new DatagramPacket(outgoing, outgoing.length, this.packet.getAddress(), this.packet.getPort());
